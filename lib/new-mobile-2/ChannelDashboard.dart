          ...
          children: [
            ...
            Positioned(
              bottom: MediaQuery.of(context).viewInsets.bottom > 0
                  ? -3
                  : 10, // Adjust bottom padding to ensure the nav bar stays above the keyboard
              left: 0,
              right: 0,
              child: SingleChildScrollView(
                ...
                child: SizedBox(
                  ...
                  child: Column(
                    children: [
                      Container(
                        padding: EdgeInsets.fromLTRB(12 * fem, 10.5 * fem, 12 * fem, 10.5 * fem),
                        width: 445 * fem,
                        height: 61 * fem,
                        decoration: const BoxDecoration(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: TextField(
                                ...
                                textInputAction: TextInputAction.done, // Show 'Done' on iOS keyboard
                                decoration: InputDecoration(
                                  ...
                                  contentPadding: EdgeInsets.fromLTRB(15 * fem, 15 * fem, 15 * fem, 15 * fem),
                                  hintText: 'Amount',
